...
const DualCTASection = () => (
  <section id="cta" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-navy-500 to-ocean-600">
    <div className="max-w-5xl mx-auto">
      <ScrollReveal variant="blur-in">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center text-fog-100 mb-4 font-heading">
          Your future starts here
        </h2>
        <p className="text-center text-fog-100/70 mb-14 text-lg max-w-xl mx-auto">
        ...
        <ScrollReveal delay={100} variant="fade-left">
          <div className="bg-card rounded-2xl border p-8 sm:p-10 text-center shadow-sm hover-lift transition-all h-full group">
            <div className="w-16 h-16 rounded-2xl bg-ocean-500/10 flex items-center justify-center mx-auto mb-6">
              <GraduationCap className="text-ocean-500 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3" size={32} />
            </div>
            ...
            <Button size="lg" className="w-full sm:w-auto px-10 py-7 rounded-xl text-lg bg-gold-500 hover:bg-gold-600 text-white font-semibold" asChild>
        ...
        <ScrollReveal delay={300} variant="fade-right">
          <div className="bg-card rounded-2xl border p-8 sm:p-10 shadow-sm hover-lift transition-all h-full group">
            <div className="w-16 h-16 rounded-2xl bg-navy-500/10 flex items-center justify-center mx-auto mb-6">
              <Building2 className="text-navy-500 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3" size={32} />
            </div>
