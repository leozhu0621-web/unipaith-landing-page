      ...
      <div className="grid md:grid-cols-2 gap-10">
        <ScrollReveal variant="fade-left" delay={100}>
          <div className="flex items-center gap-2 mb-4">
            <GraduationCap className="h-5 w-5 text-ocean-500" />
          ...
          <Accordion type="single" collapsible className="w-full">
            {studentFAQs.map((faq, i) => (
              <AccordionItem key={i} value={`student-${i}`}>
                <AccordionTrigger className="text-left text-foreground hover:no-underline hover:text-ocean-500 transition-colors">
                  {faq.q}
                </AccordionTrigger>
