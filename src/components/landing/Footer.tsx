      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-ivory-100/60">
            <li><Link to="/students" className="hover:text-ivory-100 transition-colors">For Students</Link></li>
            <li><Link to="/institutions" className="hover:text-ivory-100 transition-colors">For Institutions</Link></li>
            <li><Link to="/ai-engine" className="hover:text-ivory-100 transition-colors">AI Engine</Link></li>
          </ul>
        </div>
        <div>
          <h5 className="font-semibold mb-3 text-sm">Company</h5>
          <ul className="space-y-2 text-sm text-ivory-100/60">
            <li><Link to="/about" className="hover:text-ivory-100 transition-colors">About</Link></li>
