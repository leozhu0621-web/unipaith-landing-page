...
const ProblemSection = () => (
  <section id="problem" className="py-24 px-4 sm:px-6 lg:px-8 bg-steel-400/15">
      ...
      <ScrollReveal delay={200}>
        <div className="grid grid-cols-3 gap-6 max-w-3xl mx-auto mb-16">
          <div className="text-center">
            <div className="text-4xl sm:text-5xl font-bold text-ocean-500 mb-1 font-heading">
              <AnimatedCounter end={12} suffix="+" />
            </div>
            <p className="text-sm text-muted-foreground">applications per student, on average</p>
          </div>
          <div className="text-center">
            <div className="text-4xl sm:text-5xl font-bold text-ocean-600 mb-1 font-heading">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <ScrollReveal delay={100} variant="fade-left">
          <div className="bg-card rounded-2xl border p-8 sm:p-10 shadow-sm h-full">
            <div className="w-14 h-14 rounded-xl bg-ocean-500/10 flex items-center justify-center mb-6">
              <GraduationCap className="text-ocean-500" size={28} />
            </div>
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li className="flex items-start gap-2"><span className="text-ocean-500 mt-1">✦</span> Filling out the same forms over and over</li>
              <li className="flex items-start gap-2"><span className="text-ocean-500 mt-1">✦</span> No clear signal on which programs actually fit</li>
              <li className="flex items-start gap-2"><span className="text-ocean-500 mt-1">✦</span> Tracking deadlines across dozens of schools</li>
              <li className="flex items-start gap-2"><span className="text-ocean-500 mt-1">✦</span> Guessing at eligibility with no real data</li>
            </ul>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={300} variant="fade-right">
          <div className="bg-card rounded-2xl border p-8 sm:p-10 shadow-sm h-full">
            <div className="w-14 h-14 rounded-xl bg-navy-500/10 flex items-center justify-center mb-6">
              <Building2 className="text-navy-500" size={28} />
            </div>
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li className="flex items-start gap-2"><span className="text-navy-500 mt-1">✦</span> Manually reviewing thousands of inconsistent applications</li>
              <li className="flex items-start gap-2"><span className="text-navy-500 mt-1">✦</span> No standardized data to compare candidates fairly</li>
              <li className="flex items-start gap-2"><span className="text-navy-500 mt-1">✦</span> Growing compliance and integrity concerns</li>
              <li className="flex items-start gap-2"><span className="text-navy-500 mt-1">✦</span> Missing right-fit students who never surface</li>
            </ul>
          </div>
        </ScrollReveal>
      </div>
